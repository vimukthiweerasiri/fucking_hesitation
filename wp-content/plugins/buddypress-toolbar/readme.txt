...
* Tested with WordPress branches 3.6 Beta, 3.5+, 3.4+ and 3.3+ - also in debug mode (no stuff there, ok? :)
...
* Plugin: ["BP Checkins 1.0+" (free, by Imath)](http://wordpress.org/extend/plugins/bp-checkins/)
...
* Plugin: ["BuddyPress Relate Groups to Blogs" (free, by spurge)](http://wordpress.org/extend/plugins/bp-relate-groups-to-blogs/)
* Plugin: ["BuddyBox" (free, by Imath)](http://wordpress.org/extend/plugins/buddybox/)
* Plugin: ["BuddyPress Group Folders" (free, by Rudolf Enberg)](http://wordpress.org/extend/plugins/buddypress-group-folders/)
...
* Plugin: "BP Profiles Statistics 1.1+" (premium, by slaFFik)
...
* Plugin: ["BP Polls 1.2+" (free, by Themekraft)](https://github.com/Themekraft/BP-Polls)
* Plugin: ["BuddyPress Extended Settings" (free, by modemlooper)](http://wordpress.org/extend/plugins/buddypress-extended-settings/)
* Plugin: ["BP Menus" (free, by modemlooper)](http://wordpress.org/extend/plugins/buddypress-profile-menu/)
* Plugin: ["BuddyPress Mobile" (aka BuddyMobile) (free, by modemlooper)](http://wordpress.org/extend/plugins/buddypress-mobile/)
* Plugin: ["BuddyPress Share It" (aka BuddyShare) (free, by modemlooper)](http://wordpress.org/extend/plugins/buddypress-share-it/)
* Plugin: ["BuddyPress Media Component 2.0+" (free, by rtCamp)](http://wordpress.org/extend/plugins/buddypress-media/)
* Plugin: ["BuddyPress BP Gallery" (free, by Caevan Sachinwalla)](http://wordpress.org/extend/plugins/bp-gallery/)
...
* Plugin: ["Breadcrumbs Everywhere 1.1+" (free, by Betsy Kimak)](http://wordpress.org/extend/plugins/breadcrumbs-everywhere/)
* Plugin: ["BuddyStream" (free, by Peter Hofman)](http://wordpress.org/extend/plugins/buddystream/)
* Plugin: ["BuddyPress MyMood 1.6+" (free, by Ayush)](http://wordpress.org/extend/plugins/buddypress-mymood/)
...
* Plugin: ["BuddyPress Custom Profile Menu" (free, by Sensible Plugins)](http://wordpress.org/extend/plugins/buddypress-custom-profile-menu/) (free lite version!)
* Plugin: ["Invite Anyone" (free, by Boone Gorges)](http://wordpress.org/extend/plugins/invite-anyone/)
* Plugin: ["BP Trunk Junc" (free, by modemlooper)](http://wordpress.org/extend/plugins/bp-trunk-junc/) - Beta Tester plugin
* Plugin: ["SeoPress" (free by Themekraft)](http://wordpress.org/extend/plugins/seopress/)
...
* Plugin: ["Members Import" (free, by Manish Kumar Agarwal)](http://wordpress.org/extend/plugins/members-import/)
...
* Theme Framework with child themes: "Genesis Framework" (premium) via ["Genesis Connect for BuddyPress" plugin (free since v1.2)](http://wordpress.org/extend/plugins/genesis-connect-for-buddypress/) - both by StudioPress/Copyblogger Media LLC.
...
* Themes: "Visual" (premium) and "Fanwood 0.1.6+" (free) (both by DevPress)
...
* Themes: "3colours", "Bruce", "Detox", "Ines", "Ice", "NewYorker", "Niukita", "Soho", "Solitude", "Speed", "Spyker" - all from 3oneseven.com (all 11 free, by milo317)
...
* French (fr_FR) - user-submitted - currently 22% complete for v1.6.0
...
**IMPORTANT NOTE:** Please do only install with latest BuddyPress branches - that is v1.6+. The plugin is also compatible with the former 1.5 branch, though. Do never ever install this plugin together with *older* versions of BuddyPress! It will break your site. So, you've been warned.

**Multisite install:** Yes, it's fully compatible but have a look in the [FAQ section here](http://wordpress.org/extend/plugins/buddypress-toolbar/faq/) for more info :)
...
1. BuddyPress Toolbar in action - primary level - default state. ([Click here for larger version of screenshot](https://www.dropbox.com/s/t0v2v4wh6030yll/screenshot-1.png))
2. BuddyPress Toolbar in action - second level - BP settings/components and frondend roots pages of active components. ([Click here for larger version of screenshot](https://www.dropbox.com/s/badrmixj7ieotec/screenshot-2.png))
3. BuddyPress Toolbar in action - second level - BP user field groups (plus some specific extensions). ([Click here for larger version of screenshot](https://www.dropbox.com/s/6ci1jscuro7p5ua/screenshot-3.png))
4. BuddyPress Toolbar in action - third level - BP users management (plus some specific extensions). ([Click here for larger version of screenshot](https://www.dropbox.com/s/keqo70at7k6ckt9/screenshot-4.png))
5. BuddyPress Toolbar in action - second level - optinal BP Groups management group (only if supporting plugins are active!). ([Click here for larger version of screenshot](https://www.dropbox.com/s/nb0m3px68mrrzn5/screenshot-5.png))
6. BuddyPress Toolbar in action - third level - extensions support (here with a huge list of active plugins :). ([Click here for larger version of screenshot](https://www.dropbox.com/s/r52b81hkqiyna31/screenshot-6.png))
7. BuddyPress Toolbar in action - second level - resource links group. ([Click here for larger version of screenshot](https://www.dropbox.com/s/vtqr6fdyvcdmyku/screenshot-7.png))
8. BuddyPress Toolbar in action - translations/language specific links at the bottom - for example: German locale. ([Click here for larger version of screenshot](https://www.dropbox.com/s/ve13h60tju9hix0/screenshot-8.png))
...
= 1.6.0 =
Several additions & improvements: Improved Groups admin support, plus extended plugin support. Some updates & code improvements. Further, updated .pot file for translators and German translations.

= 1.5.1 =
Several additions & improvements: Extended plugin support. Minor updates & code improvements. Further, updated .pot file for translators and German translations.

= 1.5.0 =
Several additions & improvements: Extended plugin support. Minor updates & code improvements. Further, updated .pot file for translators and German translations.

= 1.4.1 =
Maintenance release: Added additional 'function_exists' checks to avoid possible compatibility issues on upgrades.

= 1.4.0 =
Several additions & improvements: Added help tab system. Extended plugin and theme support. Minor updates & code improvements. Further, updated .pot file for translators and German translations.
...
* English - default, always included
* German (de_DE): Deutsch - immer dabei! [Download auch via deckerweb.de](http://deckerweb.de/material/sprachdateien/buddypress/#buddypress-toolbar)
* French (fr_FR): Français - user-submitted, only a few strings yet...
